package com.dishtest.common.utils.file;
...
import com.dishtest.common.exception.file.FileNameLengthLimitExceededException;
import com.dishtest.common.exception.file.FileSizeLimitExceededException;
import com.dishtest.common.exception.file.InvalidExtensionException;
import com.dishtest.common.utils.DateUtils;
import com.dishtest.common.utils.StringUtils;
import com.dishtest.common.utils.uuid.IdUtils;
import com.dishtest.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = DishTestConfig.getProfile();
    ...
    {
        int dirLastIndex = DishTestConfig.getProfile().length() + 1;
