...
class Mobile(models.Model):
    ...
    stop_time = models.DateField("到期时间", blank=True, null=True)
    ...
    config = models.TextField("配置详情", default=json.dumps(DEFAULT_SCRCPY_KWARGS))
    ...
    class Meta:
        verbose_name_plural = verbose_name = '设备列表'
