...
class MobileForm(forms.ModelForm):
    ...
    control = forms.BooleanField(label="开启控制", required=False)
    ...
    video_bit_rate = forms.IntegerField(label='视频比特率', help_text='100000, 此时视频比特率为800kbs', required=False)
    ...
    max_size = forms.IntegerField(label='最大尺寸', required=False)
